    ...
    semesters: [
      {
        ...
        events: [
          ...
          {
            nameEn: "Appeal Application Submission Deadline, 3 pm",
            nameAr: "الموعد النهائي لتقديم طلب الاستئناف، 3 مساءً",
            date: "2024-08-20",
            type: "deadline",
          },
          {
          ...
          {
            nameEn: "Qatar National Day (1 Day)",
            nameAr: "اليوم الوطني (يوم واحد)",
            date: "2024-12-18",
            type: "holiday",
          },
          {
            nameEn: "Grades Released to Students (Fall)",
            nameAr: "إصدار الدرجات للطلاب (الخريف)",
            date: "2024-12-19",
            type: "academic",
            tentative: true,
          },
      ...
      },
      {
        ...
        events: [
          ...
          },
          {
            ...
            nameAr: "بداية الفصل الشتوي/عودة الهيئة التعليمية",
            date: "2024-12-29",
            type: "academic",
          },
          {
          ...
          {
            nameEn: "Eid Al-Fitr (5 Days)",
            nameAr: "عيد الفطر (5 أيام)",
          ...
          {
            nameEn: "Grades Released to Students (Winter)",
            nameAr: "إصدار الدرجات للطلاب (الشتاء)",
            date: "2025-05-01",
            type: "academic",
            tentative: true,
          },
      ...
      },
      {
        ...
        events: [
          ...
          },
          {
            ...
            nameAr: "بداية الفصل الربيعي/عودة الهيئة التعليمية",
            date: "2025-04-30",
            type: "academic",
          },
          {
          ...
          {
            nameEn: "Eid Al-Adha (5 Days)",
            nameAr: "عيد الأضحى (5 أيام)",
          ...
          {
            nameEn: "Grades Released to Students (Spring)",
            nameAr: "إصدار الدرجات للطلاب (الربيع)",
            date: "2025-07-10",
            type: "academic",
            tentative: true,
          },
      ...
      },
      {
        ...
        events: [
          {
            nameEn: "Start of Fall Term / Faculty Return Date",
            nameAr: "بداية الفصل الخريفي/عودة الهيئة التعليمية",
            date: "2025-08-24",
            type: "academic",
          },
        ],
